...
/// <see cref="IProductImageLookup"/>: <c>Modules.Catalog.Application</c> no puede referenciar otro
/// modulo de negocio —<c>CatalogLayerTests</c> lo verifica— y el almacenamiento vive en
...
/// </summary>
public interface IProductExportStorage
{
    Task<ProductExportUpload> UploadAsync(
        Guid tenantId,
        string fileName,
        byte[] content,
...
/// </summary>
public sealed record ProductExportUpload(string DownloadUrl, DateTimeOffset ExpiresAt);
