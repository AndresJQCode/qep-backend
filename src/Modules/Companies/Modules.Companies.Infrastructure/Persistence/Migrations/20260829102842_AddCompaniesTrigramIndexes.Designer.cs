...
namespace Modules.Companies.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260829102842_AddCompaniesTrigramIndexes")]
    partial class AddCompaniesTrigramIndexes
    {
        /// <inheritdoc />
                    ...
                    b.OwnsMany("Modules.Companies.Domain.CompanyBankAccount", "BankAccounts", b1 =>
                        {
                            ...
                            NpgsqlIndexBuilderExtensions.HasMethod(b1.HasIndex("AccountNumber"), "gin");
                            NpgsqlIndexBuilderExtensions.HasOperators(b1.HasIndex("AccountNumber"), new[] { "gin_trgm_ops" });
