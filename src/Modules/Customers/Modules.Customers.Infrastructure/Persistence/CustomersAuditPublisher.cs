...
// Acumula un evento platform.audit.recorded.v1 en la proyeccion de outbox de CustomersDbContext
// para que commitee atomico con el cambio. El worker de proyeccion del modulo Audit lo escribe en
// audit.entries.
internal sealed class CustomersAuditPublisher(CustomersDbContext dbContext)
    : ICustomersAuditPublisher
{
