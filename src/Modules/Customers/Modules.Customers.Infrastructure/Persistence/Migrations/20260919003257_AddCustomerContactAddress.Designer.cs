...
namespace Modules.Customers.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260919003257_AddCustomerContactAddress")]
    partial class AddCustomerContactAddress
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Modules.Customers.Domain.Customer", b =>
                {
                    ...
                    b.Property<bool>("VatSurplus")
                        .HasColumnType("boolean")
                        .HasColumnName("vat_surplus");
            ...
            modelBuilder.Entity("Modules.Customers.Domain.CustomerAddress", b =>
                {
                    ...
                    b.HasIndex("CityId")
                        .HasDatabaseName("IX_customer_addresses_city");

                    b.HasIndex("CustomerId")
                        .HasDatabaseName("IX_customer_addresses_customer");

                    b.HasIndex("CustomerId", "IsPrincipal")
