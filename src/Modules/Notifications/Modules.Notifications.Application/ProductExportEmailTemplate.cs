...
/// <summary>
/// Renderiza el email con el enlace de descarga de una exportación del catálogo. Gemelo de
/// <see cref="CustomerExportEmailTemplate"/>: plantilla inmutable, variables en allowlist
/// (destinatario, enlace, nombre de archivo, cantidad y vencimiento) y localización en español.
///
...
/// </summary>
public static class ProductExportEmailTemplate
{
    public const string TemplateRef = "catalog.product-export-ready.v1";
        ...
        DateTimeOffset expiresAt)
    {
        ...
        var textBody =
            $"Hola,\n\n" +
            $"La exportación que solicitaste ya está lista: {fileName} ({products}).\n" +
        ...
        var htmlBody =
            ...
            $"<strong>{htmlFileName}</strong> ({products}).</p>" +
