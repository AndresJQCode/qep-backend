...
namespace Modules.Quotations.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260925030221_AddOrdersExportLayout")]
    partial class AddOrdersExportLayout
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Modules.Quotations.Domain.OrdersExportLayout", b =>
                {
                    b.Property<Guid>("TenantId")
                        .HasColumnType("uuid")
                        .HasColumnName("tenant_id");
                    ...
                    b.HasKey("TenantId")
                        .HasName("PK_orders_export_layouts");

                    b.ToTable("orders_export_layouts", "quotations");
                });
            ...
            modelBuilder.Entity("Modules.Quotations.Domain.Quotation", b =>
                {
                    ...
                    b.Property<int?>("GlobalScaleFloor")
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Modules.Quotations.Domain.QuotationItem", b =>
                {
                    ...
                    b.Property<string>("DiscountOrigin")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
            ...
            modelBuilder.Entity("Modules.Quotations.Domain.OrdersExportLayout", b =>
                {
                    b.OwnsMany("Modules.Quotations.Domain.OrdersExportColumnSetting", "Columns", b1 =>
                        {
                            b1.Property<Guid>("OrdersExportLayoutTenantId");
                            ...
                            b1.HasKey("OrdersExportLayoutTenantId", "__synthesizedOrdinal");

                            b1.ToTable("orders_export_layouts", "quotations");
                            ...
                            b1.WithOwner()
                                .HasForeignKey("OrdersExportLayoutTenantId");
                        });
