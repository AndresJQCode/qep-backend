...
/// <summary>El mismo rango que cotizaciones (D3), sobre la fecha del pedido:
/// <c>convertedFrom</c>/<c>convertedTo</c>.</summary>
public sealed class ExportOrdersValidatorTests
{
    ...
    private static ExportOrdersCommand NewCommand(DateOnly? from, DateOnly? to) =>
